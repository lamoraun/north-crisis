            ...
            <DialogContent dividers sx={{ bgcolor: 'background.default', p: isMobile ? 2 : 3 }}>
                <Box sx={{ py: 1 }}>
                    ...
                    <Box sx={{ mb: 3 }}>
                        ...
                        <Typography variant="body2">
                            <strong>Как использовать:</strong> ПВ — это единственный способ повлиять на Имперское единство (ИЕ). Получаемые каждой страной ПВ сразу же прибавляются к показателю ИЕ. В случае проведения выборов императора курфюрст с наибольшим количеством ПВ будет иметь преимущество.
                        </Typography>
                    </Box>
